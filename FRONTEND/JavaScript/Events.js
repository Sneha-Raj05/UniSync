document.addEventListener("DOMContentLoaded", () => {
    ...
    // ======================================================
    // THEME & LOGOUT STYLES (Dynamic Injection)
    // ======================================================
    const injectStyles = () => {
    ...
    // ======================================================
    // NAVBAR LOGOUT & THEME LOGIC
    // ======================================================
    const setupNavbar = () => {
        // Find the Login button in the original HTML
        ...
        if (loginBtn) {
            ...
            // Add Theme Toggle Icon before Logout button
