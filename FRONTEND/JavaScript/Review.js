...
window.handleEdit = (id, oldComment, oldRating) => {
    ...
    // Fix 1: Directly setting value avoids quote/newline break issues
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const loadReviews = async () => {
        try {
            ...
            reviewsDisplay.innerHTML = saved.map(rev => {
                ...
                // Fix 2: Escape backticks and newlines for the onclick attribute
    ...
    // ... Rest of the setup (Submit, Theme, Stars)
